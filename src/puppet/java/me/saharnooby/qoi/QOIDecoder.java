...
public final class QOIDecoder {
	 ...
	 */
	public static QOIImage decode(@NotNull InputStream inputStream, int channels) throws IOException {
	 ...
	 * @throws IOException On any IO error.
	 */
	public static QOIImage decode(@NotNull InputStream inputStream, int channels, boolean doNotTouchDataAfterImage) throws IOException {
	...
	private static byte[] read3(@NotNull Input in, int width, int height) throws IOException {
	...
	private static byte[] read4(@NotNull Input in, int width, int height) throws IOException {
		// Check for overflow on big images
	...
	private static final class Input {
		...
		private Input(@NotNull InputStream in, boolean useBuffer) {
			this.in = in;
